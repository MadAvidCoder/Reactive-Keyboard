...
async fn main(spawner: Spawner) {
    ...
    let (row_pins, col_pins) = config_matrix_pins_nrf!(peripherals: p, input: [P1_15, P1_13, P1_11, P0_10, P0_09], output:  [P0_11, P1_00, P0_24, P0_22, P0_20, P0_17]);
    ...
    let mut battery_processor = BatteryProcessor::new(806000, 2806000);
