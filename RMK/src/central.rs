...
async fn main(spawner: Spawner) {
    ...
    // Initialize IO Pins
    let (row_pins, col_pins) = config_matrix_pins_nrf!(peripherals: p, input: [P1_15, P1_13, P1_11, P0_10, P0_09], output:  [P0_17, P0_20, P0_22, P0_24, P1_00, P0_11]);
    ...
    let keyboard_device_config = DeviceConfig {
        vid: 0x4c4b,
        pid: 0x4643,
        manufacturer: "MadAvidCoder",
        product_name: "Reactive Keyboard",
    ...
    let peripheral_addrs = read_peripheral_addresses::<1, _, 5, 12, 2, 0>(&mut storage).await;
    ...
    let mut batt_proc = BatteryProcessor::new(806000, 2806000);
